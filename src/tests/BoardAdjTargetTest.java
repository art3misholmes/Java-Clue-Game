...
public class BoardAdjTargetTest {
	...
	public void testTargetsInWalkWay() {
		// test a roll of 1
		Set<BoardCell> targets = board.getTargets(board.getCell(10, 4), 1);
	...
	public void testTargetsAtBoardEdge() {
		// top edge
		Set<BoardCell> targets = board.getTargets(board.getCell(0, 3), 1);
		assertSetContents(targets, board.getCell(0, 4), board.getCell(1, 3));

		// left edge
		targets = board.getTargets(board.getCell(13, 0), 1);
		assertSetContents(targets, board.getCell(13, 1), board.getCell(14, 0));

		// right edge
		targets = board.getTargets(board.getCell(17, 22), 1);
		assertSetContents(targets, board.getCell(16, 22), board.getCell(17, 21));

		// bottom edge
		targets = board.getTargets(board.getCell(25, 12), 1);
	...
	public void testTargetsOccupied() {
		...
		targets = board.getTargets(board.getCell(6, 2), 1);
		...
		targets = board.getTargets(board.getCell(23, 20), 1);
